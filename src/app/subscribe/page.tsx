  ...
  return (
    <div className="min-h-screen flex flex-col bg-white text-[#0f0f0f] font-sans">
      ...
      <main className="w-full flex-grow">
        ...
        {/* HERO SECTION */}
        <section className="w-full max-w-[1380px] mx-auto px-4 xl:px-0 py-16 flex flex-col lg:flex-row items-center justify-between gap-12">
          {/* Left: Pricing */}
        ...
        {/* INFO BAR */}
        <div className="w-full max-w-[1380px] mx-auto border-t border-b border-[#0f0f0f] py-8 mb-16 mt-8">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 md:gap-4 px-4 xl:px-0">
        ...
        <section className="w-full max-w-[1380px] mx-auto px-4 xl:px-0 mb-20 relative">
        ...
        <div className="w-full border-t border-black max-w-[1380px] mx-auto mb-10"></div>
        ...
        <div className="w-full border-t border-black max-w-[1380px] mx-auto mb-10 mt-16"></div>

        {/* WHAT'S INCLUDED */}
        <section className="w-full max-w-[1380px] mx-auto px-4 xl:px-0 mb-20">
        ...
        <section className="w-full max-w-[1380px] mx-auto px-4 xl:px-0 mb-32 md:mb-48 border-t border-gray-300 pt-4">
        ...
        {/* TRUSTED BY MILLIONS */}
        <section className="w-full max-w-[1380px] mx-auto px-4 xl:px-0 mb-32 border-t border-black pt-20 mt-24">
        ...
        <section className="w-full max-w-[1380px] mx-auto px-4 xl:px-0 mb-24">
