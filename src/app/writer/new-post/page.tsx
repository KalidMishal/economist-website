          ...
          <div className="flex-1 px-10 pt-10 pb-10 flex flex-col relative">
            ...
            <div className="relative">
              ...
              <div ref={editorRef} contentEditable onClick={handleEditorClick}
                ...
                className="w-full min-h-[400px] text-lg text-gray-800 p-8 focus:ring-0 outline-none bg-transparent transition-colors break-words break-all whitespace-pre-wrap [&_a]:text-[#e3120b] [&_a]:underline [&_a]:font-bold [&_a]:transition-all [&_a:hover]:text-[#ff3333] [&_a:hover]:[text-shadow:0_0_8px_rgba(227,18,11,0.5)] [&_ul]:list-disc [&_ol]:list-decimal [&_ul]:ml-6 [&_ol]:ml-6 [&_li]:mb-1 [&_blockquote]:border-l-4 [&_blockquote]:border-[#e3120b] [&_blockquote]:pl-4 [&_blockquote]:italic [&_blockquote]:my-4 [&_blockquote]:text-gray-600 [&_blockquote]:bg-gray-50 [&_blockquote]:py-3 [&_blockquote]:pr-4 [&_pre]:bg-gray-100 [&_pre]:p-4 [&_pre]:rounded [&_pre]:my-4 [&_pre]:font-[inherit] [&_pre]:text-[inherit] [&_pre]:whitespace-pre-wrap [&_pre]:flow-root"
              />
            </div>
            {tags.length > 0 && (
