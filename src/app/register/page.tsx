        ...
        <div className="w-full flex flex-col">
          ...
          <form className="flex flex-col gap-5" onSubmit={handleRegister}>
            ...
            <button 
              type="submit"
              disabled={loading}
              className="w-full bg-[#3b4b9b] text-white font-bold text-[15px] py-3 rounded-[3px] hover:bg-[#2c3975] transition-colors mt-4 disabled:opacity-50 flex items-center justify-center gap-2"
            >
