...
new_content = re.sub(
    r'(<div className="absolute left-0 w-full bg-white border border-gray-200 shadow-xl rounded-md z-\[200\] py-1 bottom-full mb-1 max-h-\[250px\] overflow-y-auto">.*?</div>\n\s*</>\n\s*\)}\n\s*</div>\n\s*</div>)',
    r'\1\n' + sidebar_ui,
    content,
    flags=re.DOTALL
)
